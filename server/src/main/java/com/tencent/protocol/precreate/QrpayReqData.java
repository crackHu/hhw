package com.tencent.protocol.precreate;
...
public class QrpayReqData {
     ...
     */
    public QrpayReqData(String trade_type,String body,String attach,String outTradeNo,int totalFee,String goodsTag,String url) throws ParseException{
      ...
      //  setSub_mch_id(subMchID);//服务号下的子商户号
...
//        setSpbill_create_ip(spBillCreateIP);
        ...
        setTime_start(ChangeType.curDay());

        //订单失效时间，格式同上
        setTime_expire(ChangeType.TomorrowYearDay());

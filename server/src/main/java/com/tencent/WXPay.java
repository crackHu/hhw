...
import com.tencent.service.QrPayService;
...
public class WXPay {
	...
	public static void initSDKConfiguration(String key, String appID, String mchID, String sdbMchID,
		...
		Configure.setCertLocalPath(WXPay.class.getClassLoader().getResource("").getPath() + certLocalPath);
	 ...
	 * @throws Exception
	 */
	public static void doScanPayBusiness(ScanPayReqData scanPayReqData, ScanPayBusiness.ResultListener resultListener)
			throws Exception {
	...
	public static String requestQrPayService(QrpayReqData data)
			throws ClassNotFoundException, IllegalAccessException, InstantiationException, Exception {
		return new QrPayService().request(data);
	}

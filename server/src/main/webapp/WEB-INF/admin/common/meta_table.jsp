...
<!-- notify -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/assets/css/jquery.gritter.css" />
<!-- notify -->
...
<script src="${pageContext.request.contextPath}/admin/assets/js/jquery.form.js"></script>
<script src="${pageContext.request.contextPath}/admin/assets/js/bootbox.min.js"></script>
<script type="text/javascript">
	if ("ontouchend" in document)
		document.write("<script src='${pageContext.request.contextPath}/admin/assets/js/jquery.mobile.custom.min.js'>"
				+ "<"+"/script>");
</script>
...
<!-- notify -->
<script src="${pageContext.request.contextPath}/admin/assets/js/jquery.gritter.min.js"></script>
<!-- notify -->
...
<script src="${pageContext.request.contextPath}/admin/assets/js/date-time/bootstrap-datepicker.min.js"></script>
		<script src="${pageContext.request.contextPath}/admin/assets/js/jqGrid/jquery.jqGrid.min.js"></script>
		<script src="${pageContext.request.contextPath}/admin/assets/js/jqGrid/i18n/grid.locale-en.js"></script>
<!-- ace scripts -->

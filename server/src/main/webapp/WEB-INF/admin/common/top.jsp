	...
	<div class="navbar-container" id="navbar-container">
		<div class="navbar-header pull-left">
			<a href="#" class="navbar-brand"> <small> <i
					class="icon-leaf"></i> VDS5S3后台管理系统
			</small>
			</a>
			<!-- /.brand -->
		</div>
			...
			<ul class="nav ace-nav">
				...
				<li class="green"><a data-toggle="dropdown"
					...
					<ul
						...
						<li><a href="#"> <img src="${pageContext.request.contextPath}/admin/assets/avatars/avatar.png"
						...
						<li><a href="#"> <img src="${pageContext.request.contextPath}/admin/assets/avatars/avatar3.png"
						...
						<li><a href="#"> <img src="${pageContext.request.contextPath}/admin/assets/avatars/avatar4.png"

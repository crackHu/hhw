...
<title>Vds5s3后台管理系统</title>
</head>

<%@ include file="common/meta_data.jsp"%>
<body>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Bob Doe's avatar"
																		src="${pageContext.request.contextPath}/admin/assets/avatars/user.jpg" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Joe Doe's avatar"
																		src="${pageContext.request.contextPath}/admin/assets/avatars/avatar2.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Jim Doe's avatar"
																		src="${pageContext.request.contextPath}/admin/assets/avatars/avatar.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Alex Doe's avatar"
																		src="${pageContext.request.contextPath}/admin/assets/avatars/avatar5.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Susan's avatar"
																		src="${pageContext.request.contextPath}/admin/assets/avatars/avatar3.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Phil Doe's avatar"
																		src="${pageContext.request.contextPath}/admin/assets/avatars/avatar4.png" />
																</div>
															...
															<div class="itemdiv memberdiv">
																<div class="user">
																	<img alt="Alexa Doe's avatar"
																		src="${pageContext.request.contextPath}/admin/assets/avatars/avatar1.png" />
																</div>
										...
										<div class="widget-body">
											<div class="widget-main no-padding">
												<div class="dialogs">
													...
													<div class="itemdiv dialogdiv">
														<div class="user">
															<img alt="John's Avatar" src="${pageContext.request.contextPath}/admin/assets/avatars/avatar.png" />
														</div>
													...
													<div class="itemdiv dialogdiv">
														<div class="user">
															<img alt="Bob's Avatar" src="${pageContext.request.contextPath}/admin/assets/avatars/user.jpg" />
														</div>
													...
													<div class="itemdiv dialogdiv">
														<div class="user">
															<img alt="Jim's Avatar" src="${pageContext.request.contextPath}/admin/assets/avatars/avatar4.png" />
														</div>

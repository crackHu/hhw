					...
					<div
						...
						<div class="op-container clearfix">
							...
							<button class="btn btn-info pull-right"
								onclick="addEntity('admin/adminUser/showAdd','admin/adminUser/add','添加管理员');">添加</button>
						</div>
						<div class="panel" style="display: block;">
							<div class="panel-body easyui-panel width100" id="table"
								data-options="border:false,href:'${pageContext.request.contextPath}/admin/adminUser/getTableView?pageNum=1&pageSize=10'">
							</div>
...
<script type="text/javascript">
		...
		pagination = $('#pagination').pagination(
				{
					...
					onSelectPage : function(pageIndex, pageSize) {
						$('#table').panel(
								'refresh',
								'${pageContext.request.contextPath}/admin/adminUser/getTableView?pageNum='
	...
	updatePagination = function(pageNum, pageSize) {
		$
				.ajax({
					url : '${pageContext.request.contextPath}/admin/adminUser/getTablePage',
					data : {
						pageNum : pageNum,
						pageSize : pageSize,
					},

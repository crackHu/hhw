				...
				<div class="col-lg-12">
					<div
						...
						<div class="op-container clearfix">
							...
							<div class="pill-right pullRight col-sm-2">
						...
						<div class="panel" style="display: block;">
							<div class="panel-body easyui-panel width100" id="table"
								data-options="border:false,href:'${pageContext.request.contextPath}/admin/perform/getTableView?pageNum=1&pageSize=10'">
							</div>
...
<script type="text/javascript">
		...
		pagination = $('#pagination').pagination(
				{
					...
					onSelectPage : function(pageIndex, pageSize) {
						$('#table').panel(
								'refresh',
								'${pageContext.request.contextPath}/admin/perform/getTableView?pageNum='
	...
	updatePagination = function(pageNum, pageSize) {
		...
		$
				.ajax({
					url : '${pageContext.request.contextPath}/admin/perform/getTablePage',
					data : {
						pageNum : pageNum,
						pageSize : pageSize,
						search : search

					...
					<div
						...
						<div class="op-container clearfix">
							...
							<button class="btn btn-info pull-right"
								onclick="addEntity('admin/businessType/showAdd','admin/businessType/add','添加商户类型');">添加</button>
						</div>
						<div class="panel" style="display: block;">
							<div class="panel-body easyui-panel width100" id="table"
								data-options="border:false,href:'${pageContext.request.contextPath}/admin/businessType/getTableView?pageNum=1&pageSize=10'">
							</div>
...
<script type="text/javascript">
		...
		pagination = $('#pagination').pagination(
				{
					...
					onSelectPage : function(pageIndex, pageSize) {
						$('#table').panel(
								'refresh',
								'${pageContext.request.contextPath}/admin/businessType/getTableView?pageNum='
	...
	updatePagination = function(pageNum, pageSize) {
		$
				.ajax({
					url : '${pageContext.request.contextPath}/admin/businessType/getTablePage',
					data : {
						pageNum : pageNum,
						pageSize : pageSize,
					},

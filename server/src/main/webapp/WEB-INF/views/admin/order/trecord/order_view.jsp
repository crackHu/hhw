						...
						<div id="myTabContent" class="tab-content">
							<div id="all" class="tab-pane panel fade in active"
								...
								<div class="panel-body easyui-panel width100" id="table"
									data-options="border:false,href:'${pageContext.request.contextPath}/admin/order/trecord/getTableView?pageNum=1&pageSize=10'">
								</div>
...
<script type="text/javascript">
		...
		pagination = $('#pagination').pagination(
				{
					...
					onSelectPage : function(pageIndex, pageSize) {
						$('#table').panel(
								'refresh',
								'${pageContext.request.contextPath}/admin/order/trecord/getTableView?pageNum='
										+ pageIndex + '&pageSize=' + pageSize + '&search='+search
										);
	...
	updatePagination = function(pageNum, pageSize) {
		$
				.ajax({
					url : '${pageContext.request.contextPath}/admin/order/trecord/getTablePage',
					data : {
						pageNum : pageNum,
						pageSize : pageSize,
						search : search
	...
	refalshList = function() {
		...
		$('#table').panel(
				'refresh',
				'${pageContext.request.contextPath}/admin/order/getTableView?pageNum='

						...
						<div id="myTabContent" class="tab-content">
							<div id="all" class="tab-pane panel fade in active"
								...
								<div class="panel-body easyui-panel width100" id="table"
									data-options="border:false,href:'${pageContext.request.contextPath}/admin/order/getTableView?pageNum=1&pageSize=10&status=${status}'">
								</div>
...
<script type="text/javascript">
	...
	updatePagination = function(pageNum, pageSize) {
		$
				.ajax({
					url : '${pageContext.request.contextPath}/admin/order/getTablePage',
					data : {
						pageNum : pageNum,
						pageSize : pageSize,
						status : status,

...
CREATE TABLE `tb_order` (
  `or_id` varchar(32) NOT NULL,
  `or_barcode` varchar(32) NOT NULL,
  `or_us_id` varchar(32) NOT NULL,
  `or_status` int(2) DEFAULT NULL,
  `or_park_site_id` varchar(32) DEFAULT NULL,
  `or_park_type` varchar(2) DEFAULT NULL,
  `or_start_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '开始停车时间',
  `or_end_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '停止停车的时间 ',
  `or_car_id` varchar(32) DEFAULT NULL COMMENT '用户车辆id',
  `or_first_price` decimal(10,2) DEFAULT NULL COMMENT '开始支付金额',
  `or_add_price` decimal(10,2) DEFAULT NULL COMMENT '累计支付金额',
  `or_operator_id` varchar(32) DEFAULT '' COMMENT '操作人id',
  `or_is_invoice` int(2) DEFAULT NULL COMMENT '是否开发票',
  `or_invoice_title` varchar(255) DEFAULT NULL COMMENT '发票抬头',
  `or_is_privilege` int(2) NOT NULL DEFAULT '0' COMMENT '是否哟特权',
  `or_create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `or_modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`or_id`)
...
CREATE TABLE `tb_order_gift` (
  `or_gf_id` varchar(255) NOT NULL,
  `or_gf_us_id` varchar(255) DEFAULT NULL,
  `or_gf_gk_id` varchar(255) DEFAULT NULL,
  `or_gf_code` varchar(255) DEFAULT NULL,
  `or_gf_is_user` int(2) DEFAULT NULL,
  `or_gf_start_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `or_gf_end_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `or_gf_price` decimal(10,2) DEFAULT NULL,
  `or_gf_create_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `or_gf_modfiy_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`or_gf_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_order_gift_kind` (
  `or_gk_id` varchar(255) NOT NULL,
  `or_gk_name` varchar(255) DEFAULT NULL,
  `or_gk_begin_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `or_gk_end_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `or_gk_desc` varchar(255) DEFAULT NULL,
  `or_gk_is_enabled` int(2) NOT NULL DEFAULT '0',
  `or_gk_is_exchange` int(2) NOT NULL DEFAULT '0',
  `or_gk_point` int(20) DEFAULT NULL,
  `or_gk_price` decimal(10,2) DEFAULT NULL,
  `or_gk_price_expression` varchar(255) DEFAULT NULL,
  `or_gk_prefix` varchar(255) DEFAULT NULL,
  `or_gk_create_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `or_gk_modify_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`or_gk_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_order_payment` (
  `or_pay_id` varchar(255) NOT NULL,
  `or_pay_us_id` varchar(255) DEFAULT NULL,
  `or_pay_or_id` varchar(255) DEFAULT NULL,
  `or_pay_account` varchar(255) DEFAULT NULL,
  `or_pay_amount` varchar(255) DEFAULT NULL,
  `or_pay_bank` varchar(255) DEFAULT NULL,
  `or_pay_expire_time` datetime DEFAULT NULL,
  `or_pay_fee` varchar(255) DEFAULT NULL,
  `or_pay_memo` varchar(255) DEFAULT NULL,
  `or_pay_method` varchar(255) DEFAULT NULL,
  `or_pay_time` datetime DEFAULT NULL,
  `or_pay_sno` varchar(255) DEFAULT NULL,
  `or_pay_status` int(255) DEFAULT NULL,
  `or_pay_create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `or_pay_modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`or_pay_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_order_pay_kind` (
  `or_pk_id` varchar(255) NOT NULL,
  `or_pk_name` varchar(255) DEFAULT NULL,
  `or_pk_code` varchar(255) DEFAULT NULL,
  `or_pk_order` int(255) DEFAULT NULL,
  `or_pk_desc` varchar(255) DEFAULT NULL,
  `or_pk_icon` varchar(255) DEFAULT NULL,
  `or_pk_method` varchar(255) DEFAULT NULL,
  `or_pk_timeout` datetime DEFAULT NULL,
  `or_pk_content` varchar(255) DEFAULT NULL,
  `or_create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `or_modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`or_pk_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `tb_plug_in` VALUES ('40282381596f689701596f68a9c40000', 'plug', 'plug_V1.0.0', '2', '启动成功...', '2017-01-06 00:14:07', '2017-01-06 00:14:07');
INSERT INTO `tb_plug_in` VALUES ('40282381596f689701596f68a9f40001', 'user', 'user_V1.0.0', '2', '启动成功...', '2017-01-06 00:14:07', '2017-01-06 00:14:07');
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES ('1', '王企鹅群无', '大师', '18816837260', 'fasdf', '1', '0', '2017-01-05 23:01:53', '2017-01-05 23:01:53');
...
-- ----------------------------
INSERT INTO `tb_user_token` VALUES ('1', '1', '1', '2017-01-05 23:01:08');
